...
#define LOG_ERROR_GETTING_FD_MAPPING (14)
#define LOG_ERROR_PUTTING_CONNECT_INFO (15)
#define LOG_ERROR_GETTING_CONNECT_INFO (16)
#define LOG_ERROR_READING_CONNECT_INFO (17)
#define LOG_ERROR_READING_SOCKET_FAMILY (18)
#define LOG_ERROR_READING_SOCKET_DADDR (19)
#define LOG_ERROR_READING_SOCKET_SADDR (20)
#define LOG_ERROR_READING_SOCKET_DPORT (21)
#define LOG_ERROR_READING_SOCKET_SPORT (22)
#define LOG_DEBUG (23)
