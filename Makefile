...
release:
	...
	@cd ../kubeshark.github.io/ && rm -rf ./charts/chart && mkdir ./charts/chart && cp -r ../kubeshark/helm-chart/* ./charts/chart/
	@git add -A . && git commit -m ":sparkles: Update the Helm chart" && git push
	@cd ../kubeshark
