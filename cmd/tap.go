...
const tlsCaptureHelp = "Capture traffic encrypted with OpenSSL, BoringSSL (including Envoy/Istio), or Go crypto/tls libraries"
...
func init() {
	...
	tapCmd.Flags().Bool(configStructs.TlsLabel, defaultTapConfig.Tls, tlsCaptureHelp)
