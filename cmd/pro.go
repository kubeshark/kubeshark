...
func runLicenseRecieverServer() {
	...
	ginApp.Use(func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, accept, origin, Cache-Control, X-Requested-With, x-session-token, Refresh-Token")
