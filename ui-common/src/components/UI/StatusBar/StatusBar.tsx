...
import warningIcon from 'src/components/UI/assets/warning_icon.svg';
import failIcon from 'src/components/UI/assets/failed.svg';
import successIcon from 'src/components/UI/assets/success.svg';
